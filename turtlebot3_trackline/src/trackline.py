...
class Trackline:
    def __init__(self):
        ...
        self.intensity_sub = rospy.Subscriber('/robot1/intensity_scan', LaserScan, self.intensity_cb)
        self.controler_pub = rospy.Publisher('/robot1/cmd_vel', Twist, queue_size=10)
        self.intensities = []
    ...
    def move_robot(self, x = -0.3, y = -2.0):
        ...
        msg = rospy.wait_for_message('/robot1/move_base/result', MoveBaseActionResult, timeout=None)
